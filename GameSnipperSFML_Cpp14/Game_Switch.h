...
public:
	...
	Game_Switch(DrawContainer* container, std::string img, b2Vec2 position, int widht, int height);

	Game_Switch(DrawContainer* container, GameObjectContainer *GameObjectContainer, std::string img, b2Vec2 position, int widht, int height);

	Game_Switch(b2Vec2 position, int widht, int height);
	Game_Switch(GameObjectContainer *useContainer, b2Vec2 position, int widht, int height);
